...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.authorizeRequests().antMatchers("/h2-console/**", "/getHealthcheck","/getdata").permitAll()
				.and().csrf().ignoringAntMatchers("/h2-console/**", "/getHealthcheck","/getdata").and().headers()
